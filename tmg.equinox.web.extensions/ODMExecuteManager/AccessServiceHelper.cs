...
{
    public static class AccessServiceHelper
    {
        static internal JObject GetTableObject(TableInfo table)
        {
        ...
        static internal string GetQuery(TableInfo table, string whereClause, bool allColumns)
        {
            string query = "";
