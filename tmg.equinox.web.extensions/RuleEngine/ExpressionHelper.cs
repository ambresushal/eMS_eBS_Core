...
namespace tmg.equinox.web.RuleEngine
{
    ...
    {
        static NumberStyles style = NumberStyles.Currency;
        static CultureInfo culInfo = new CultureInfo("en-US");
        public static bool Equal(string val1, string val2)
        {
            decimal n1, n2;
            bool result = decimal.TryParse(val1, style, culInfo.NumberFormat, out n1) && decimal.TryParse(val2, style, culInfo.NumberFormat, out n2) ? n1 == n2 : string.Equals(val1, val2);
            return result;
        }
        ...
        public static bool GreaterThan(string val1, string val2, bool hasDate)
        {
            ...
            else
            {
                ...
                {
                    if (decimal.TryParse(ReplaceSymbol(val1), style, culInfo.NumberFormat, out n1) && decimal.TryParse(ReplaceSymbol(val2), style, culInfo.NumberFormat, out n2))
                    {
                        result = n1 > n2;
                    }
                }
                ...
                {
                    if (decimal.TryParse(val1, style, culInfo.NumberFormat, out n1) && decimal.TryParse(val2, style, culInfo.NumberFormat, out n2))
                    {
                        result = n1 > n2;
                    }
                }
