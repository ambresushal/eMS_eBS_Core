...
namespace tmg.equinox.documentcomparer
{
    public class RepeaterExcelReportGenerator
    {
        ...
        {
            int column = 2;
            int endColumn = column + repeaterCompareResult.Keys.Count +repeaterCompareResult.Fields.Count - 1;
            ...
            int numberOfColumns = repeaterCompareResult.Keys.Count + repeaterCompareResult.Fields.Count;
            row = row + 1;
