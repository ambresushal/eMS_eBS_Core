...
* Works perfect with TinyMCE Advanced.
...
* Removed annotation on frontend. User could see it inspecting the DOM.
...
* Bugfix: double quotation mark allowed in annotations.
* Added user feedback notices.
