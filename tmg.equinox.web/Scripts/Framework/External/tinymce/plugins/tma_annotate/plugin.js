...
tinymce.PluginManager.add('tma_annotate', function (editor, url) {
    ...
    // Create annotation
    editor.addMenuItem('tma_annotate', {
                ...
                editor.windowManager.open({
                    ...
                    onsubmit: function (e) {
                        if (e.data.annotation) {
                            ...
                            var userName = editor.getParam("custom_user_name");
                            editor.selection.setContent('<span class="annotation" data-author="' + userName + '" data-annotation="' + dataAnnotation.replace(/"/g, '&quot;') + '" style="background-color:' + e.data.annotationbg + '">' + selectedText + '</span>');
    ...
    // Delete annotation
    editor.addMenuItem('tma_annotatedelete', {
        title: 'Delete annotation',
