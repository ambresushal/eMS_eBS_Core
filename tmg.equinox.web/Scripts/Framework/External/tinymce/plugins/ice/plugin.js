(function () {
    tinymce.create('tinymce.plugins.IcePlugin', {
        ...
        iceacceptall: null,
        icerejectall: null,
        ice_toggleshowchanges: null,
        ice_togglechanges: null,
        ...
        init: function (ed, url) {
            ...
            ed.on('postRender', function (e) {
                ...
                var state = true;;
                ice_toggleshowchanges.active(state);
                //ed.controlManager.setActive('ice_toggleshowchanges', true);
                if (self.isTracking) {
                    var state1 = true;
                    ice_togglechanges.active(state);
            ...
            ed.addCommand('ice_toggleshowchanges', function () {
                ...
                var body = ed.getBody(), cm = ed.controlManager, disable = true;

                if (ed.dom.hasClass(body, 'CT-hide')) {
                    var state = true;
                    ed.fire('ice_toggleshowchanges', { state: state });
                ...
                iceacceptall.disabled(disable);
                icerejectall.disabled(disable);
                //});
            ...
            ed.addCommand('ice_enable', function () {
                ...
                //ed.controlManager.setActive('ice_togglechanges', true);
                var state = true;
                ed.fire('ice_togglechanges', { state: state });
            ...
            //Modified 05/24/2018 - to support change tracking for chrome
            ed.addQueryStateHandler('ice_isTracking', function () {
                return changeEditor.isTracking ? true : false;
            })
            //End
            ...
            ed.addButton('iceaccept', {
                ...
                cmd: 'iceaccept',
                onPostRender: function () { iceaccept = this; }
            });
            ...
            ed.addButton('icereject', {
                ...
                cmd: 'icereject',
                onPostRender: function () { icereject = this; }
            });
            ...
            ed.addButton('iceacceptall', {
                ...
                cmd: 'iceacceptall',
                onPostRender: function () { iceacceptall = this; }
            });
            ...
            ed.addButton('icerejectall', {
                ...
                cmd: 'icerejectall',
                onPostRender: function () { icerejectall = this; }
            });
            ...
            //    if (isInsideChangeTag(e.element.nodeValue)) {
            //        iceaccept.disabled(false);
            //        icereject.disabled(false);

            //    } else {
            //        iceaccept.disabled(true);
            //        icereject.disabled(true);
            //    }
            //    cleanup();
            //});
            ...
            function toggleState() {
                var self = this;
                ice_toggleshowchanges = this;
                ed.on('ice_toggleshowchanges', function (e) {
                    self.active(e.state);
                });
            }
            ...
            function toggleState1() {
                var self = this;
                ice_togglechanges = this;
                ed.on('ice_togglechanges', function (e) {
                    self.active(e.state);
                });
            }
