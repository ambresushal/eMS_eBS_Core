var manageReportSetting = function () {
    ...
    this.URLs = {
        ...
        getReportNameList: '/DocumentCollateral/GetCollateralNames?tenantId=1',
        designTemplateDelete: '/ReportDesign/deleteDesignTemplate',
    }
    ...
    function loadReportTemplateGrid() {
        ...
        var colArray = ['', 'Report Name','', 'Version Number'];
        //set column models
        var colModel = [];
        colModel.push({ name: 'ReportId', index: 'ReportId', key: true, hidden: true, editable: false });
        colModel.push({ name: 'ReportName', index: 'ReportName', editable: false });
        colModel.push({ name: 'ReportTemplateVersionID', index: 'ReportTemplateVersionID', hidden: true, editable: false });
        colModel.push({ name: 'VersionNumber', index: 'VersionNumber', editable: false });
