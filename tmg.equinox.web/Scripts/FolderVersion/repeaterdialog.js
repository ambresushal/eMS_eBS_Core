var repeaterdialog = function (rowId, elementData, repeaterBuilder, isRowReadOnly, repeaterData) {
...
repeaterdialog.prototype.generateRowLayout = function () {
...
repeaterdialog.prototype.generateRowLayoutPQ = function () {
    var currentInstance = this;
    var richTextBoxIds = [];
...
repeaterdialog.prototype.loadTinyMCE = function (id) {
    tinymce.remove(id);
    tinymce.init({
        selector: id,
        statusbar: false,
...
repeaterdialog.prototype.getsubArrays = function (data, subSection, gridDataSourceName) {
    var currentInstance = this;
    for (var key in data) {
...
repeaterdialog.prototype.CreateLayout = function () {
    var currentInstance = this;
...
repeaterdialog.prototype.CreateLayoutPQ = function (richTextBoxIds) {
    var currentInstance = this;
    var row = currentInstance.rowData;
    var displayName = currentInstance.elementData;
    var rowId = currentInstance.rowID;
        ...
        $.each(displayName, function (id, name) {
            if (name.Id == key && name.Visible == true) {
                ...
                if (name.Type === "checkbox") {
                    ...
                    if (name.Type === "select") {
                        if (displayText != "Limits" && displayText != "Message" && displayText != "Tier" && displayText != "Alt Rule") {
                            //if (((currentInstance.repeaterBuilder.fullName == currentInstance.repeaterBuilder.customrule.fullName.benefitReviewGridAltRulesData
...
repeaterdialog.prototype.CreateInLineLayout = function (row, inlineRowId) {
    var currentInstance = this;
    var displayName = currentInstance.elementData;
    var rowId = currentInstance.rowID;
...
repeaterdialog.prototype.init = function () {
    var currentInstance = this;
...
repeaterdialog.prototype.show = function () {
    var currentInstance = this;
...
repeaterdialog.prototype.showPQ = function (hasSavebutton) {
    var currentInstance = this;
    currentInstance.init();
    $(currentInstance.elementIDs.repeaterRowDataJQ).hide().fadeIn("slow");
    ...
    $(currentInstance.elementIDs.repeaterDialogPrevButton).unbind("click");
    $(currentInstance.elementIDs.repeaterDialogPrevButton).bind("click", function () {
        var gridArr = $(currentInstance.repeaterBuilder.gridElementIdJQ).pqGrid("option", "dataModel.data");
        var selrow = $(currentInstance.repeaterBuilder.gridElementIdJQ).getGridParam("selrow");
        var currIndex = 0;
        for (var i = 0; i < gridArr.length; i++) {
            ...
            $(currentInstance.elementIDs.repeaterDialogSaveButton).bind("click", function () {
                ...
                if (isValidations.length > 0) {
                    ...
                    if (currentInstance.repeaterBuilder.design.LoadFromServer == true) {
                        ...
                        var gridPQData = $(currentInstance.repeaterBuilder.gridElementIdJQ).pqGrid("option", "dataModel.data");
...
repeaterdialog.prototype.showRepeaterTemplate = function () {
    var currentInstance = this;
    currentInstance.init();
    if (!currentInstance.repeaterBuilder.formInstanceBuilder.IsMasterList) {
...
repeaterdialog.prototype.viewTemplateData = function () {
    var currentInstance = this;
...
repeaterdialog.prototype.showNavigateOptions = function () {
    var currentInstance = this;
...
repeaterdialog.prototype.showNavigateOptionsPQ = function () {
    var currentInstance = this;
    var rowIds = $(currentInstance.repeaterBuilder.gridElementIdJQ).pqGrid("option", "dataModel.data");
...
repeaterdialog.prototype.loadChildGrid = function (childGridData) {
    var currentInstance = this;
    var colArray = [];
    var colModel = [];
...
repeaterdialog.prototype.getSelectListOptions = function (items, selectedValue, isSortRequired) {
    ...
    if (items) {
        if (items.length > 0) {
            $.each(items, function (idx, value) {
                options += "<option value='" + value.ItemValue + "' " + (selectedValue === value.ItemValue ? "selected" : "") + ">" + value.ItemValue + "</option>";
            });
        }
    }
    return options;
...
repeaterdialog.prototype.getDropdownTextboxOptions = function (items, selectedValue, isSortRequired) {
    if (isSortRequired == true) {
        items = sortDropDownElementItems(items);
    }
...
repeaterdialog.prototype.pickDates = function (idpluscol, elementDesign) {
    var currentInstance = this;
...
repeaterdialog.prototype.formatDropdownTextbox = function (idpluscol, elementDesign, idpluscolRepeater) {
    var currentInstance = this;
    var count = 0;
...
repeaterdialog.prototype.invokeCallback = function (rowData, rowID) {
    var currentInstance = this;
    currentInstance.repeaterBuilder.updateCallBack(rowData, rowID);
}

repeaterdialog.prototype.runRuleForRepeaterDialog = function (rule, parentRowId, childRowId) {
    var currentInstance = this;
    currentInstance.repeaterBuilder.ruleProcessor.processRule(rule, parentRowId, childRowId, this);
}

repeaterdialog.prototype.setElementErrorState = function (result, rule, row) {
    var currentInstance = this;
...
repeaterdialog.prototype.visibleRuleResultCallBack = function (rule, result) {
    var currentInstance = this;
...
repeaterdialog.prototype.ruleResultCallBack = function (rule, row, retVal, childName, childIdx) {
    var currentInstance = this;
...
repeaterdialog.prototype.setParentRow = function (rule, row, retVal) {
    var currentInstance = this;
...
repeaterdialog.prototype.setChildRow = function (rule, row, retVal, childName, childIdx) {
    var currentInstance = this;
    if (rule.ParentRepeaterType == 'In Line') {
...
repeaterdialog.prototype.loadRulesForElement = function (ruleElem) {
    var currentInstance = this;
    var elem = ruleElem;
    var rowId = currentInstance.rowID;
    var designElem = currentInstance.repeaterBuilder.design.Elements.filter(function (el) {
...
repeaterdialog.prototype.loadValidationsForElement = function (validElem) {
    var currentInstance = this;
    var elem = validElem;
    var rowId = currentInstance.rowID;
...
repeaterdialog.prototype.loadValidationsForElementPQ = function (validElem) {
    var currentInstance = this;
    var elem = validElem;
    var rowId = currentInstance.rowID;
    var path = currentInstance.repeaterBuilder.fullName + '.' + elem.id.split('_')[1];
    ...
    //currentPage = $(currentInstance.repeaterBuilder.gridElementIdJQ).getGridParam('page');
    //var rowNum = $(currentInstance.repeaterBuilder.gridElementIdJQ).getGridParam('rowNum');
    currentPage = $(currentInstance.repeaterBuilder.gridElementIdJQ).pqGrid("option", "pageModel.curPage");
...
repeaterdialog.prototype.loadDuplicationsForElement = function (duplicateElem) {
    var currentInstance = this;
...
repeaterdialog.prototype.loadDuplicationsForElementPQ = function (duplicateElem) {
    var currentInstance = this;
    var elem = duplicateElem;
    var rowId = currentInstance.rowID;
    var path = currentInstance.repeaterBuilder.fullName + '.' + elem.id.split('_')[1];
    ...
    if (designElem != null && designElem.length > 0) {
        ...
        if (currentInstance.repeaterBuilder.formInstanceBuilder.designData.Duplications != null || currentInstance.repeaterBuilder.formInstanceBuilder.designData.Duplications != undefined) {
            ...
            if (duplicationObject.length > 0) {
                //var gridRowData = $(currentInstance.repeaterBuilder.gridElementIdJQ).jqGrid('getGridParam', 'data');
                var gridRowData = $(currentInstance.repeaterBuilder.gridElementIdJQ).pqGrid("option", "dataModel.data");
                var gridData = gridRowData.filter(function (ct) {
                    if (ct.RowIDProperty == rowId) {
                        ct[designElem.GeneratedName] = elem.value;
                    }
...
repeaterdialog.prototype.processRules = function () {
    var currentInstance = this;
