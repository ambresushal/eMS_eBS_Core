    ...
    if (path == "OONGroups.ManualOverride") {
        ...
        if (res !== undefined) {
            ...
            $.each(repeaterBuilders, function (idx, val) {
                var repeaterId = '#' + val.design.Name + val.formInstanceId;
    ...
    return {
        clickHandler: function (ev, eventArgs) {
            ...
            if (eventArgs.value == true) {
                //display message
                // yesNoConfirmDialog.show("Do you want to enable manual override. If manual override is enabled, the system will not auto generate values for the OON Groups.", function (e) {
            ...
            if (eventArgs.value == false) {
                //display message
                //yesNoConfirmDialog.show("All changes made to OON Groups will be lost. The system will auto generate values for the OON Groups.", function (e) {
