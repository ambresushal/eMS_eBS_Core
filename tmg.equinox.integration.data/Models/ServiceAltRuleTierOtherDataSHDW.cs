...
{
    public class ServiceAltRuleTierOtherDataSHDW : Entity
    {
        ...
        public ServiceAltRuleTierOtherDataSHDW Clone()
        {
            return this.MemberwiseClone() as ServiceAltRuleTierOtherDataSHDW;
        }
    }
}
