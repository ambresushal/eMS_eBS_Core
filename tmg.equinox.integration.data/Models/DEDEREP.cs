...
{
    public partial class DEDEREP:Entity
    {
        ...
        public double DEDE_FAM_AMT { get; set; }
        public double DEDE_FAM_AMT_CO { get; set; }
        public double DEDE_MEME_AMT { get; set; }
        public double DEDE_MEME_AMT_CO { get; set; }
