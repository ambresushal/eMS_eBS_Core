...
{
    public partial class PDBC481Arc : Entity
    {
        public int PDBC_Id { get; set; }
        public Nullable<int> ebsInstanceId { get; set; }
        public string PDPD_ID { get; set; }
        public string PDBC_TYPE { get; set; }
        public Nullable<System.DateTime> PDBC_EFF_DT { get; set; }
        public Nullable<System.DateTime> PDBC_TERM_DT { get; set; }
        public string PDBC_PFX { get; set; }
        public string PDBC_OPTS { get; set; }
        public Nullable<short> PDBC_LOCK_TOKEN { get; set; }
