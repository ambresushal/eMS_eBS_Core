...
{
    public class AdditionalServiceAltRuleDataSHDW : Entity
    {
        ...
        public AdditionalServiceAltRuleDataSHDW Clone()
        {
            return this.MemberwiseClone() as AdditionalServiceAltRuleDataSHDW;
        }
    }
}
