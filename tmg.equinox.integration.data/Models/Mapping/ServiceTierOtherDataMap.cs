...
{
    public class ServiceTierOtherDataMap : EntityTypeConfiguration<ServiceTierOtherData>
    {
        public ServiceTierOtherDataMap()
        {
            this.HasKey(t => new { t.PDPD_ID, t.SESE_ID, t.BenefitSet, t.SETR_TIER_No, t.ProcessGovernance1up });            

            this.ToTable("SETROtherModeldata", "ModelData");
