...
{
    public class ServiceTier0DataSHDWMap : EntityTypeConfiguration<ServiceTier0DataSHDW>
    {
        public ServiceTier0DataSHDWMap()
        {
            this.HasKey(t => new { t.PDPD_ID, t.SESE_ID, t.BenefitSet, t.SETR_TIER_No });            

            this.ToTable("SETRSHDWModeldata", "ModelData");
