...
{
    public class ServiceAltRulePenaltyDataSHDWMap : EntityTypeConfiguration<ServiceAltRulePenaltyDataSHDW>
    {
        public ServiceAltRulePenaltyDataSHDWMap()
        {
            this.HasKey(t => t.PDPD_ID);
            this.HasKey(t => t.SESE_ID);

            this.ToTable("SESPAltSHDWModeldata", "ModelData");
