...
{
    public class ProductMigrationQueueMigMap : EntityTypeConfiguration<ProductMigrationQueueMig>
    {
        public ProductMigrationQueueMigMap()
        {
            // Primary Key
            this.HasKey(t => t.ProductMigrationQueue1Up);

            // Table & Column Mappings
            this.ToTable("ProductMigrationQueue", "Migration");
