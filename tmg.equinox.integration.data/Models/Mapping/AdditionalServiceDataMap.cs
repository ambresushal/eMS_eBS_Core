...
{
    public class AdditionalServiceDataMap: EntityTypeConfiguration<AdditionalServiceData>
    {
        public AdditionalServiceDataMap()
        {
            this.HasKey(t => new { t.PDPD_ID, t.SESE_ID, t.BenefitSet, t.ProcessGovernance1up });            

            this.ToTable("AdditionalServiceModeldata", "ModelData");
