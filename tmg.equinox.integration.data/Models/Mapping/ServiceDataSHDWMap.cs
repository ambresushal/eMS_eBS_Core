...
{
    public class ServiceDataSHDWMap:EntityTypeConfiguration<ServiceDataSHDW>
    {
        public ServiceDataSHDWMap()
        {
            this.HasKey(t => new { t.SESE_ID, t.BenefitSet, t.POS, t.BenefitCategory1, t.BenefitCategory2, t.BenefitCategory3 });

            this.ToTable("ServiceSHDWModeldata", "ModelData");
            this.Property(t => t.PDPD_ID).HasColumnName("PDPD_ID");
            this.Property(t => t.SESE_ID).HasColumnName("SESE_ID");
            //this.Property(t => t.ServiceGroupName).HasColumnName("ServiceGroupName");
