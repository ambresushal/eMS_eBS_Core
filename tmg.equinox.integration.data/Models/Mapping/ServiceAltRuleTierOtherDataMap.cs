...
{
    public class ServiceAltRuleTierOtherDataMap:EntityTypeConfiguration<ServiceAltRuleTierOtherData>
    {
        public ServiceAltRuleTierOtherDataMap()
        {
            this.HasKey(t => new { t.PDPD_ID, t.SESE_ID, t.BenefitSet, t.ProcessGovernance1up });            

            this.ToTable("SETROtherAltModeldata", "ModelData");
