...
{
    public class SESETRANSMap : EntityTypeConfiguration<SESETRANS>
    {
        public SESETRANSMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SESEId });
            ...
            this.ToTable("SESETRANS", "Trans");
            this.Property(t => t.SESEId).HasColumnName("SESEId");
