...
{
    public class ServiceAltRuleDataSHDWMap: EntityTypeConfiguration<ServiceAltRuleDataSHDW>
    {
        public ServiceAltRuleDataSHDWMap()
        {
            this.HasKey(t => t.PDPD_ID);
            this.HasKey(t => t.SESE_ID);

            this.ToTable("ServiceAltSHDWModeldata", "ModelData");
