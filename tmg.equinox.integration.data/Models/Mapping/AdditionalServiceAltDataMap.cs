...
{
    public class AdditionalServiceAltDataMap : EntityTypeConfiguration<AdditionalServiceAltRuleData>
    {
        public AdditionalServiceAltDataMap()
        {
            this.HasKey(t => new { t.PDPD_ID, t.SESE_ID, t.BenefitSet, t.ProcessGovernance1up });
            
            this.ToTable("AdditionalServiceAltModeldata", "ModelData");
