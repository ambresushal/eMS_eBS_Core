...
{
    public class PluginTransmissionProcessQueueMap : EntityTypeConfiguration<PluginTransmissionProcessQueue>
    {
        public PluginTransmissionProcessQueueMap()
        {
            // Primary Key
            ...
            this.ToTable("PluginTransmissionProcessQueue", "common");
