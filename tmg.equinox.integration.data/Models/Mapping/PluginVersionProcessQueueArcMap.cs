...
{
    public class PluginVersionProcessQueueArcMap : EntityTypeConfiguration<PluginVersionProcessQueueArc>
    {
        public PluginVersionProcessQueueArcMap()
        {
            // Primary Key
            ...
            this.ToTable("PluginVersionProcessQueue", "arc_481");
