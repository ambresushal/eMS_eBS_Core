...
{
    public class ServiceTierOtherDataSHDWMap : EntityTypeConfiguration<ServiceTierOtherDataSHDW>
    {
        public ServiceTierOtherDataSHDWMap()
        {
            this.HasKey(t => new { t.PDPD_ID, t.SESE_ID, t.BenefitSet, t.SETR_TIER_No });            

            this.ToTable("SETROtherSHDWModeldata", "ModelData");
