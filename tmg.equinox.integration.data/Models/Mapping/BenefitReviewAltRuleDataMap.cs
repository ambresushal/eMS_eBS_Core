...
{
    public class BenefitReviewAltRuleDataMap : EntityTypeConfiguration<BenefitReviewAltRuleData>
    {
        public BenefitReviewAltRuleDataMap()
        {
            this.HasKey(t => new { t.PDPD_ID, t.SESE_ID, t.BenefitSet, t.ProcessGovernance1up });

            this.ToTable("SETRAltModeldata", "ModelData");
