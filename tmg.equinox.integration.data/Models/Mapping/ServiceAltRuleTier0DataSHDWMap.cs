...
{
    public class ServiceAltRuleTier0DataSHDWMap : EntityTypeConfiguration<ServiceAltRuleTier0DataSHDW>
    {
        public ServiceAltRuleTier0DataSHDWMap()
        {
            this.HasKey(t => new { t.PDPD_ID, t.SESE_ID, t.BenefitSet,t.SETR_TIER_No });            

            this.ToTable("SETRAltSHDWModeldata", "ModelData");
