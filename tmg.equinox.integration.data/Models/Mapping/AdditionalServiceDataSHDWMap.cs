...
{
    public class AdditionalServiceDataSHDWMap : EntityTypeConfiguration<AdditionalServiceDataSHDW>
    {
        public AdditionalServiceDataSHDWMap()
        {
            this.HasKey(t => new { t.PDPD_ID, t.SESE_ID, t.BenefitSet });            

            this.ToTable("AdditionalServiceSHDWModeldata", "ModelData");
