...
{
    public class SESPMasterMap : EntityTypeConfiguration<SESPMaster>
    {
        public SESPMasterMap()
        {
            // Primary Key
            this.HasKey(t => new { t.SESE_RULE ,t.SERL_REL_ID});
            ...
            this.ToTable("SESPRULEConfig", "Master");
