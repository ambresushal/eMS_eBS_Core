...
{
    public class ServicePenaltyDataSHDWMap: EntityTypeConfiguration<ServicePenaltyDataSHDW>
    {
        public ServicePenaltyDataSHDWMap()
        {
            this.HasKey(t => t.PDPD_ID);
            this.HasKey(t => t.SESE_ID);

            this.ToTable("SESPSHDWModeldata", "ModelData");
