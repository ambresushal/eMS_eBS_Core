...
{
    public partial class DEDE481Arc : Entity
    {
        ...
        public Nullable<short> DEDE_RULE { get; set; }
        public Nullable<short> DEDE_REL_ACC_ID { get; set; }
        public string DEDE_COB_OOP_IND { get; set; }
        public string DEDE_SL_IND { get; set; }
        public string DEDE_PERIOD_IND { get; set; }
        public Nullable<short> DEDE_AGG_PERSON { get; set; }
        public Nullable<short> DEDE_AGG_PERSON_CO { get; set; }
        public Nullable<decimal> DEDE_FAM_AMT { get; set; }
        public Nullable<decimal> DEDE_FAM_AMT_CO { get; set; }
        public Nullable<decimal> DEDE_MEME_AMT { get; set; }
        public Nullable<decimal> DEDE_MEME_AMT_CO { get; set; }
        ...
        public Nullable<short> DEDE_LOCK_TOKEN { get; set; }
