...
namespace tmg.equinox.integration.qhplite.Ver2016.DocumentExporter
{
    ...
    /// </summary>
    public class DocumentExporter2020BenefitPackageTemplate : IDocumentExporter
    {
        ...
        {
            public const string QhpFolderPath = "\\App_Data\\Qhp\\2020 Template\\";
            public const string UploadedQhpTemplateFolderPath = "\\App_Data\\Qhp\\2020 Template\\";
        ...
        #region Constructor
        public DocumentExporter2020BenefitPackageTemplate(string folderPath, IList<QhpDocumentViewModel> qhpDocumentList)
        {
        ...
        {
            QHPModelToExcelMapper2020BenefitPackageTemplate mapper = new QHPModelToExcelMapper2020BenefitPackageTemplate(GetPlanBenefitPackages(), _helperfilePath, _filePath);
