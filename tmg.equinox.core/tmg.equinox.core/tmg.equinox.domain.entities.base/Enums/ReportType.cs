...
namespace tmg.equinox.domain.entities.Enums
{
    ...
    {      
        ...
        Ancillary_100_Vendor_Report = 23,
        DIV_125_Panel_Report = 24,
        Required_300_Materials_Report_MA_MAPD = 25,
		State_450_Product_Summary_SNP = 26,
        State_450_Product_Summary_Non_SNP =27,
        Service_Area_Expansions_And_Exits_475 = 28
    }
