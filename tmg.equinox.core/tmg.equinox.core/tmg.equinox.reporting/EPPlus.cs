...
namespace tmg.equinox.reporting
{
    public class EPPlus
    {
        ...
        public EPPlus(string filePath, string templateFilePath, DataTable dt)
        {
            ...
            //_ds = GetDataTables("Rpt.ReportSetting"); /* DataTables */
        ...
        //private DataSet GetDataTables(string table)
        //{
        //    string query = "SELECT * FROM " + table;
        //    DataSet ds = new DataSet();
        //    using (SqlConnection sqlConn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["UIFrameworkContext"].ConnectionString))
