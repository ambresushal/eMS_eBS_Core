...
namespace tmg.equinox.ruleinterpreter.ComplexRuleInterpreter.Core
{
    public class Constants
    {
        ...
        public const string FILTERARRAY = "FILTERARRAY";
        ...
        public const string BUILDREPORTSTRING = "BUILDREPORTSTRING";
        public const string BUILDREPORTTABLE = "BUILDREPORTTABLE";
        public const string DIVIDE = "DIVIDE";
        public const string GETCOSTSHARE = "GETCOSTSHARE";
        public const string HASCOSTSHARE = "HASCOSTSHARE";
        public const string SETSERVICES = "SETSERVICES";
		public const string NUMBERTOWORDS = "NUMBERTOWORDS";
		public const string GETDISTINCTCOLVAL = "GETDISTINCTCOLVAL";
        public const string GETBENEFITDETAIL = "GETBENEFITDETAIL";
        public const string GETGENERALBENEFIT = "GETGENERALBENEFIT";
        public const string GETDEDUCTIBLE = "GETDEDUCTIBLE";
        public const string GETOOPM = "GETOOPM";
        public const string SORTARRAY = "SORTARRAY";
        public const string DATEFORMAT = "DATEFORMAT";
        public const string ARITHMETICOPERATION = "ARITHMETICOPERATION";
        public const string MATHROUNDOFF = "MATHROUNDOFF";
        public const string SBCROUNDOFF = "SBCROUNDOFF";
        public const string UNPIVOTARRAY = "UNPIVOTARRAY";
        public const string EXTRACTSNIPPET = "EXTRACTSNIPPET";
        public const string CALCULATEDDATA = "CALCULATEDDATA";
        public const string GETCOVERAGEEXAMPLE = "GETCOVERAGEEXAMPLE";
