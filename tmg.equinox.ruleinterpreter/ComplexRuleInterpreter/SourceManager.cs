...
namespace tmg.equinox.ruleinterpreter.ComplexRuleInterpreter
{
    class SourceManager
    {
        ...
        public static Dictionary<string, JToken> GetAll(Thread t)
        {
            Dictionary<string, JToken> sourceDict = null;
            if (_dicSources.ContainsKey(t))
            {
                _dicSources.TryGetValue(t, out sourceDict);
            }
            return sourceDict;
        }
    }
